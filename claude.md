...
BeskarFolio includes a local development MCP server for seamless Claude Code integration.
...
- ✅ **Updated Documentation**: Integrated philosophy throughout `claude.md`
